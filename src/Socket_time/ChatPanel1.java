...
public class ChatPanel1 extends javax.swing.JFrame {
    ...
    public ChatPanel1(Socket s, String sender, String receiver) {
        initComponents();
        this.socket = s;
        this.sender = sender;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChatPanel1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChatPanel1().setVisible(true);
            }
        });
    }
